...
export const useStudentsStore = defineStore('students', () => {
  const profiles = ref<Record<string, StudentProfile>>({
    ...
    '0228888888': {
      ...
      firstName: 'James',
      lastName: 'Dela Cruz',
      email: 'james.delacruz@gmail.com',
    ...
    '0231111111': {
      ...
      firstName: 'Lucas',
      lastName: 'Villanueva',
      email: 'lucas.villanueva@gmail.com',
    ...
    '0235555555': {
      ...
      firstName: 'Ethan',
      lastName: 'Bautista',
      email: 'ethan.bautista@gmail.com',
