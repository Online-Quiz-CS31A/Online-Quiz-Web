        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
              ...
              <div>
                <div class="inline-flex items-center gap-3 px-5 py-3 bg-blue-50 border border-blue-100 rounded-xl">
                  <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center">
                    <i class="fas fa-star text-blue-600 text-sm"></i>
                  </div>
                  <div>
                    <p class="text-xs text-blue-600 font-medium uppercase tracking-wide">Total Points</p>
                    <p class="text-xl font-bold text-gray-900">{{ quizDetails.points }}</p>
                  </div>
                </div>
                <p class="mt-2 text-xs text-gray-500">Auto-calculated from all question points</p>
              </div>
            </div>
          </div>
