        ...
        <div class="px-6 py-4 overflow-y-auto">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select :value="modelValue.role" @change="onInput('role', ($event.target as HTMLSelectElement).value); emit('role-change')" disabled class="block w-full px-3 py-2 mt-1 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-500 cursor-not-allowed select-none" style="cursor: not-allowed;">
