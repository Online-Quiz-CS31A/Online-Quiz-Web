      ...
      <div class="w-full max-w-lg max-h-[70vh] overflow-hidden bg-white rounded-lg shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 overflow-y-auto">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              <div class="flex items-start gap-2 p-3 rounded-md bg-blue-50 border border-blue-200">
                <Mail class="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                <p class="text-xs text-blue-700">A random password will be automatically generated and sent to the user's Gmail address upon creation.</p>
              </div>
            </div>
