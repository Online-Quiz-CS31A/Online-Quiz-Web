...
<template>
  <div class="bg-white min-h-screen">
    ...
    <!-- Course Hero Section -->
    <div v-if="isLoading" class="relative overflow-hidden bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 border-b border-gray-200">
    ...
    <!-- Course Hero Section - Loaded -->
    <div v-else class="relative overflow-hidden bg-white border-b border-gray-200">
